package com.example.asus.mybudget.ThongKe;
...
public class StatsNamNay extends Activity {
    private ListView listViewtongthuchiHN = (ListView)findViewById(R.id.listViewhienthithongke);
    private ArrayList<ThongKe> listchi;
    private ArrayList<ThongKe> listthu;
    DatabaseHandler db;
    TextView tvTitle;
    ListView listView;
    Button btthu = (Button)findViewById(R.id.btthu),btchi;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout.layout_thongke);
